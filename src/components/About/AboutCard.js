      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            ...
            <p>
              <mark class="highlight-teal">여러 포지션을 다양하게 경험해온 개발자입니다.</mark> 다양한 경험을 한 분야는 게임 서버 개발, 게임 클라이언트 개발, 웹 백엔드 개발, 웹 프론트엔드 개발 등을 해왔습니다.
            </p>
            <ul>
            ...
            <p>
              <mark class="highlight-teal">기록 집착자입니다.</mark> 개발 문서, 개인 적인 취미 활동, 하루 회고, 개선안, 회의록 (개인적 차원) 등 수많은 내용을 기록하는 것이 일상입니다.
            </p>
            <ul>
